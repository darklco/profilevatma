    ...
    <style>
        * {
        ...
        @media (max-width: 480px) {
            ...
            /* Show overlay buttons always on mobile */
            .project-image::after {
                content: '';
                position: absolute;
                bottom: 10px;
...
<body>
    <section class="portfolio-section" id="portfolio">
        ...
        <div class="projects-grid" id="projectsGrid">
            ...
            <div class="project-card" data-category="backend">
                ...
                <div class="project-content">
                    ...
                    <p class="project-description">
                        A fully functional e-commerce platform with cart management, payment integration, and admin dashboard.
                    </p>
                    ...
                    <div class="project-links">
                        ...
                        <a href="#" class="project-link link-secondary">
                            Code
                        </a>
                    </div>
                </div>
            ...
            <!-- Additional projects 4-6 continue with same structure... -->
        </div>
    </section>
